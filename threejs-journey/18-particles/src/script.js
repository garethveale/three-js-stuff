...
//attenuation gives perspective
particleMaterial.sizeAttenuation= true
particleMaterial.transparent = true
particleMaterial.alphaMap = particleTexture

// these few techniques can help to solve drawing particles with textures
...
const tick = () =>
{
    ...
    // this is an awful way to animate particles -> we're updating thousands of particles
    for(let i=0;i<count;i++) {
        const i3 = i*3
